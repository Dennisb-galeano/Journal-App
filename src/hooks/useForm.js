...
export const useForm = (initialForm = {}, formValidations = {}) => {
    ...
    //decirle al formulario que si la nota cambia entinces actualice las referencias (en note de NoteView)
    useEffect(() => {
        setFormState(initialForm);
    }, [initialForm]) //cuando el valor inicial cambia(la nota activa), entonces se va a disparar
